...
$GLOBALS['index_QuickPreview_Img'] = 'on'; //文章预览是否显示图片

//样式
$GLOBALS['style_TextBar'] = '1'; //文章页头部信息 | 1:功能按钮及分享按钮(文章目录导航仅支持 h3,h4 层级) | 0:纯文本
$GLOBALS['style_TextIndent'] = 'off'; //首行缩进
$GLOBALS['style_CommentShow'] = 'on'; //默认显示评论
$GLOBALS['style_BGPic'] = 'https://api.ixiaowai.cn/api/api.php'; //博客背景图设置(填入图片链接)，留空为不开启
